...
results1 <- results1 %>% dplyr::select(name, k, r, lb, ub, s2)
write.csv(results1, "tables/table1_210108.csv")
```
...
results2 <- results2 %>% dplyr::select(name, beta, se, lb, ub, z, p, adj_p_fdr)
write.csv(results2, "tables/table2_210108.csv")
...
run_table_345 <- function(pp_filter){
  ...
  results <- results %>% dplyr::select(name, beta, se, lb, ub, z, p, adj_p_fdr)
  return(results)
}
```
...
write.csv(results3, "tables/table3_210108.csv")

results4 <- run_table_345(pp_filter = 2)
write.csv(results3, "tables/table4_210108.csv")

results5 <- run_table_345(pp_filter = 3)
write.csv(results3, "tables/table5_210108.csv")
